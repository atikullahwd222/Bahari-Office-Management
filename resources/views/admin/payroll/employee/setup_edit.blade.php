        ...
        <div class="card shadow-lg">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0 text-white">
                    <i class="bx bx-user-plus me-2"></i> Edit Employee Salary
                </h5>
            ...
            <div class="card-body">
                <form id="employeeSetupForm" action="{{ route('admin.payroll.employee.setup.update', $employee->id) }}" method="POST">
                    @csrf
                    <input type="hidden" name="employee_id" value="{{ $employee->id }}">
                    <input type="hidden" name="company_uid" value="{{ $employee->company_uid }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="salary" name="salary" required
                                       placeholder="Enter salary amount" value="{{ $employeeSetup->salary }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" id="remarks" name="remarks" rows="3"
                                      placeholder="Enter any additional remarks">{{ $employeeSetup->remarks }}</textarea>
                        </div>
                    </div>
