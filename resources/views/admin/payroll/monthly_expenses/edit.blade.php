    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Edit Monthly Expense') }}
            </h2>
            <a href="{{ route('admin.payroll.monthly-expenses') }}" class="btn btn-secondary">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white py-3">
                <h5 class="card-title mb-0 text-white">
                    <i class="bx bx-edit me-2"></i> Edit Monthly Expense
                </h5>
            </div>

            <div class="card-body">
                <form action="{{ route('admin.payroll.monthly-expenses.update', $expense->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('admin.payroll.monthly-expenses') }}" class="btn btn-secondary">Cancel</a>
