        ...
        <div class="card">
            <div class="card-header row align-items-center">
                ...
                <div class="col-md-6 d-flex justify-content-end">
                    <a href="{{ route('admin.server.index') }}" class="btn btn-danger">
                        Go Back
                    </a>
                </div>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('admin.server.store') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="port" name="port" value="22">
                        @if ($errors->has('port'))
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="control_panel" name="control_panel">
                            <option value="whm-cpanel" selected>WHM/Cpanel</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="license" name="license">
                            <option value="rc" selected>RC Licensing System</option>
                            <option value="gb">GB Licensing System</option>
                            <option value="sysconfig">Sysconfig Licensing System</option>
                            <option value="none">Licensing System not required</option>
                        </select>
