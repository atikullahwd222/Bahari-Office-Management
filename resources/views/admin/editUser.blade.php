                    ...
                    <section class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                <img src="{{ asset($employee->profile_photo) }}" alt="user-avatar"
                                    class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
                                <form action="{{ route('user.profile.update.photo', $employee->id) }}" method="post"
                        ...
                        <!-- Form Section -->
                        <div class="card-body">
                            <form method="POST" action="{{ route('user.profile.update', $employee->id) }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input id="last_name" name="last_name" type="text" class="form-control mt-1"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input id="phone" name="phone" type="text"
                                                class="form-control mt-1" placeholder="202 555 0111"
